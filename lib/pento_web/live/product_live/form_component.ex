defmodule PentoWeb.ProductLive.FormComponent do
  ...
  defp upload_static_file(%{path: path}, socket) do
    # plug in production image file persistance here...
  ...
  def upload_image_error(%{image: %{errors: errors}}, entry) when length(errors) > 0 do
    ...
    upload_image_error_msg(msg)
  end

  def upload_image_error(_, _), do: ""

  defp upload_image_error_msg(:not_accepted), do: "Invalid file type"
  defp upload_image_error_msg(:too_many_files), do: "Too many files"
  defp upload_image_error_msg(:too_large), do: "File exceeds max size"
end
